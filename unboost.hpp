    ...
    // Adapt choosed one
        ...
        namespace unboost {
            ...
            inline long stol(const std::string& str, size_t *pos = NULL, int base = 10) {
                ...
                *pos = end - str.c_str();
                if (*pos == 0) {
                    throw std::invalid_argument("unboost::stol");
                }
                return ret;
            }
            inline long stoul(const std::string& str, size_t *pos = NULL, int base = 10) {
                ...
                *pos = end - str.c_str();
                if (*pos == 0) {
                    throw std::invalid_argument("unboost::stoul");
                }
                return ret;
            }
            inline int stoi(const std::string& str, size_t *pos = NULL, int base = 10) {
                ...
                if (n > INT_MAX || n < INT_MIN) {
                    throw std::out_of_range("unboost::stoi");
                }
                ...
                stoll(const std::string& str, size_t *pos = NULL, int base = 10) {
                    ...
                    *pos = end - str.c_str();
                    if (*pos == 0) {
                        throw std::invalid_argument("unboost::stoll");
                    }
                    return ret;
                }
                ...
                stoull(const std::string& str, size_t *pos = NULL, int base = 10) {
                    ...
                    *pos = end - str.c_str();
                    if (*pos == 0) {
                        throw std::invalid_argument("unboost::stoull");
                    }
                    return ret;
                }
            ...
            inline float stof(const std::string& str, size_t *pos = NULL) {
                ...
                *pos = end - str.c_str();
                if (*pos == 0) {
                    throw std::invalid_argument("unboost::stof");
                }
                if (d > FLT_MAX || d < -FLT_MAX) {
                    throw std::out_of_range("unboost::stof");
                }
            ...
            inline double stod(const std::string& str, size_t *pos = NULL) {
                ...
                *pos = end - str.c_str();
                if (*pos == 0) {
                    throw std::invalid_argument("unboost::stod");
                }
                return ret;
            }
...
// string algorithm
    ...
    // If not choosed, choose one
    #if ((defined(UNBOOST_USE_UNBOOST_STRING_ALGORITHMS) + defined(UNBOOST_USE_BOOST_STRING_ALGORITHMS)) == 0)
        #if defined(UNBOOST_USE_BOOST)
            #define UNBOOST_USE_BOOST_STRING_ALGORITHMS
        #else
            #define UNBOOST_USE_UNBOOST_STRING_ALGORITHMS
        #endif
    #endif
    // Adapt choosed one
    ...
    #elif defined(UNBOOST_USE_UNBOOST_STRING_ALGORITHMS)
        // NOTE: Unboost String Algorithms is a subset of Boost String Algorithms.
        #include <cctype>
        namespace unboost {
            namespace char_set {
                // ansi
